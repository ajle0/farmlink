...
class BE_Controller extends PS_Controller {
	...
	function popular_categories_index()
	{
		$this->dashboard_list_view( $this->module_site_url( 'index' ));
	}
	...
	function purchased_categories_index()
	{
		$this->dashboard_list_view( $this->module_site_url( 'index' ));
	}
    ...
    function deliboy_ratings_index()
    {
        $this->dashboard_list_view( $this->module_site_url( 'index' ));
    }
	...
	*/
	 ...
	 * Index
	 */
	function order_route_index()
	{
		$this->order_route_list_view( $this->module_site_url( 'index' ));
	}
	...
	*/
	 ...
	 * Search
	*/
	function popular_categories_search()
	{
		$this->dashboard_list_view( $this->module_site_url( 'search' ));	
	}
	 ...
	 * Search
	*/
	function purchased_categories_search()
	{
		$this->dashboard_list_view( $this->module_site_url( 'search' ));	
	}

    function deliboy_ratings_search()
    {
        $this->dashboard_list_view( $this->module_site_url( 'search' ));
    }

    function all_deliboys_search()
    {
        $this->dashboard_list_view( $this->module_site_url( 'search' ));
    }
	 ...
	 * Search
	*/
	function ord_route_search()
	{
		$this->order_route_search( $this->module_site_url( 'search' ));	
	}
	 ...
	 * @param      <type>  $base_url  The base url
	 */
	function order_route_list_view( $base_url )
	{
		// pagination
		$rows_count = $this->data['rows_count'];
		$this->load_pag( $base_url, $rows_count );
		...
		// load add list
		$this->load_order_route_list_view( $this->data );
	}
	 ...
	 * @param      <type>  $base_url  The base url
	 */
	function order_route_search( $base_url )
	{
		// pagination
		$rows_count = $this->data['rows_count'];
		$this->load_pag( $base_url, $rows_count );
		...
		// load add list
		$this->load_order_route_search( $this->data );
	}
	...
	function best_choice_add()
	{
		...
		// load entry form
		$this->load_template( 'best_choices/entry_form',$this->data, true );
	}
	...
	function order_route_add()
	{
		...
		// load entry form
		$this->load_order_route_form( $this->data );
	}

	/**
	 * Update an existing record
	 */
	function order_route_edit($id)
	{
	...
	function mobile_edit( $id )
	{
		...
		// load entry form
		$this->load_template( 'mobile_settings/entry_form',$this->data, true );
	}
	 ...
	 */
	function delete_cover_photo($img_id = null, $id = null)
	{
		if (empty($img_id) || empty($id)) {
			show_error('Missing required arguments for delete_cover_photo.', 400);
			return;
		}
		// check edit access
		$this->check_access( EDIT );
	 ...
	 * @param      integer  $id  The category identifier
	 */
	function replace_cover_photo($img_type = null, $id = null)
	{
		if (empty($img_type) || empty($id)) {
			show_error('Missing required arguments for replace_cover_photo.', 400);
			return;
		}
		// check edit access
		$this->check_access( EDIT );
    ...
    /**
     * Edit the exiting record purchase category
     */
    function deliboy_ratings_edit( $id )
    {
        // check access
        $this->check_access( EDIT );
        ...
        // load entry form
        $this->load_template( 'deliboy_ratings/entry_form',$this->data, true );
    }

    /**
     * Edit the exiting record purchase category
     */
    function all_deliboys_edit( $id )
    {
        // check access
        $this->check_access( EDIT );
        ...
        // load entry form
        $this->load_template( 'all_deliboys/entry_form',$this->data, true );
    }
	
	/**
	 * deliver schedule order
	 */
	function deliver_shcedule_order( $id,$status_id,$payment_id,$delivery_boy_id )
	{	
		// check access
		$this->check_access( EDIT );
