...
class PS_Controller extends CI_Controller
{
	 ...
	 * @param      <type>  $view   The view
	 */
	function load_order_route_form( $data ) 
	{
		// load header
		$this->load_view( 'partials/header', $data );
	 ...
	 * @param      <type>  $view   The view
	 */
	function load_order_route_search( $data ) 
	{
		// load header
		$this->load_view( 'partials/header', $data );
	...
	/**
	 * Loads a route to deliver schedule order
	 *
	 * @param      <type>  $view   The view
	 */
	function load_order_route_list_view( $data ) 
	{
		// load header
		$this->load_view( 'partials/header', $data );
