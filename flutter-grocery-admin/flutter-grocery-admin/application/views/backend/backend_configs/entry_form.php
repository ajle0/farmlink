		        ...
		        <div class="row">
							...
							<div class="form-check">
								...
								<label class="form-check-label">
									...
									<?php echo form_checkbox( array(
										...
										'id' => 'search_in_shop',
										'value' => 'accept',
										'checked' => set_checkbox('search_in_shop', 1, ( @$backend->search_in_shop == 1 )? true: false ),
										'class' => 'form-check-input'
									));	?>
									<label><?php echo get_msg( 'search_in_shop' ); ?></label>
								</label>
							</div>
						</div>
					...
					<div class="col-md-6">
						<div class="form-group d-flex justify-content-between">
							<label class="col-5"><?php echo get_msg('search_in_shop_limit')?>
								<a href="#" class="tooltip-ps" data-toggle="tooltip" title="<?php echo get_msg('search_in_shop_limit')?>">
									<span class='glyphicon glyphicon-info-sign menu-icon'>
								</a>
							</label>
							<?php 
								echo form_input( array(
									'type' => 'text',
									'name' => 'search_in_shop_limit',
									'id' => 'search_in_shop_limit',
									'class' => 'form-control col-7',
									'placeholder' => get_msg('search_in_shop_limit'),
									'value' => set_value( 'search_in_shop_limit', show_data( @$backend->search_in_shop_limit ), false )
								));
							?>
						</div>
