                    ...
                    <div class="card-footer" style="padding: 20px 55px 10px 55px;">
                      <div class="row">
                        <div class="col-sm-4" style="padding-top: 10px;">
                          <a href="<?php echo site_url('admin/dashboard/index/'. $shop->id);?>" class="btn btn-block btn-outline-primary"><?php echo get_msg('dashboard_label'); ?></a>
                      </div>
                      <div class="col-sm-4" style="padding-top: 10px;">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p>1. Products and Discounts</p>
        <p>2. Products and Collection</p>
        <p>3. News Feeds</p>
        <p>4. Shipping Methods</p>
        <p>5. Watch List</p>
        <p>6. Comments</p>
        <p>7. Transactions</p>
        <p>8. Reports</p>
