        ...
        <div class="row fileupload-buttonbar">
            <div class="col-lg-7">
                ...
                <span class="btn btn-success fileinput-button">
                    ...
                    <span><?php echo get_msg('add_files'); ?>...</span>
                    <input type="file" name="files[]" multiple>
                </span>
                <button type="submit" class="btn btn-primary start">
                    <i class="glyphicon glyphicon-upload"></i>
                    <span><?php echo get_msg('start_upload'); ?></span>
                </button>
                <button type="reset" class="btn btn-warning cancel">
                    <i class="glyphicon glyphicon-ban-circle"></i>
                    <span><?php echo get_msg('cancel_upload'); ?></span>
                </button>
                <button type="button" class="btn btn-danger delete">
                    <i class="glyphicon glyphicon-trash"></i>
                    <span><?php echo get_msg('btn_delete'); ?></span>
                </button>
...
{% for (var i=0, file; file=o.files[i]; i++) { %}
    <tr class="template-upload">
        ...
        <td>
            <p class="size"><?php echo get_msg('processing_label'); ?>...</p>
        ...
        <td>
            {% if (!i && !o.options.autoUpload) { %}
                <button class="btn btn-primary start" disabled>
                    <i class="glyphicon glyphicon-upload"></i>
                    <span><?php echo get_msg('btn_start'); ?></span>
                </button>
            {% } %}
            {% if (!i) { %}
                <button class="btn btn-warning cancel">
                    <i class="glyphicon glyphicon-ban-circle"></i>
                    <span><?php echo get_msg('btn_cancel'); ?></span>
                </button>
            {% } %}
        </td>
    </tr>
