    ...
    <table class="table m-0 table-striped">
        ...
        <tr>
            ...
            <th>
                ...
                <a href="<?php echo $module_site_url .'/rating_sort/';?>"><button class="fa fa-arrow-up btn btn-xs"></button>
            </th>
            <th><?php echo get_msg('joined_date')?></th>
            ...
            <?php foreach($deliboys->result() as $deliboy): ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $date = $deliboy->updated_date;
                        $temp_date = explode(' ', $date);
                        $joined_date = $temp_date[0];
