	...
	$(document).ready(function(){
				...
				success: function( msg ) {
					if ( msg == true ){
						btn.addClass('unpublish').addClass('btn-success')
							.removeClass('publish').removeClass('btn-warning')
							.html("<?php echo get_msg( 'btn_proceed' ); ?>");
					} else {
		...
		$(document).delegate('.unpublish','click',function(){
			...
			$.ajax({
				...
				success: function( msg ){
					if ( msg == true )
						btn.addClass('publish').addClass('btn-warning')
							.removeClass('unpublish').removeClass('btn-success')
							.html("<?php echo get_msg( 'btn_paused' ); ?>");
					else
						alert( "<?php echo get_msg( 'err_sys' ); ?>" );
				}
			});
...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_schedule_order_label' ),
		'message' =>  get_msg( 'schedule_order_yes_all_message' ),
