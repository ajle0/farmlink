				...
				<div class="row">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" placeholder="<?php echo get_msg('enter_shop_name') ?>" name='name' id='name'
						...
						<div class="form-group">
							...
							<textarea class="form-control" value="<?php echo $shop->description; ?>" name="description" placeholder="<?php echo get_msg('description_label') ?>" rows="5" disabled></textarea>
						</div>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input class="form-control" type="text" value="<?php echo $shop->email; ?>" placeholder="<?php echo get_msg('contact_email_label')?>" name='email' id='email' disabled>
						</div>	
					</div>
