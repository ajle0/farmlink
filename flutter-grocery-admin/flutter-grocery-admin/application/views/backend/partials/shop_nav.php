	...
	<div class="nav-container">
		<nav class="navbar navbar-expand-lg navbar-dark">
		  	<a class="navbar-brand" href="<?php echo site_url('admin/shops/');?>">
	            ...
	            ?>
			    <img src="<?php echo isset($images[0]) ? img_url( $images[0]->img_path ) : base_url('assets/img/default-logo.png'); ?>" class="img-circle img-sm" alt="User Image">
		  	</a>
			      	...
			      	<li class="nav-item dropdown">
			        	...
			        	<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		            		...
		            		<a class="dropdown-item" href='<?php echo site_url('/admin/subcategories');?>'> 
		  				    ...
		  				    <div class="dropdown-divider"></div>
		  				    <a class="dropdown-item" href='<?php echo site_url('/admin/best_choices');?>'> 
		  				  		&#10148; <?php echo get_msg('best_choice'); ?>
		  				    </a>
			      ...
			      -->
			      	...
			      	<li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<div class="dropdown-divider"></div>
				          	<a class="dropdown-item" href="<?php echo site_url('/admin/mobile_settings');?>"> 
								  		&#10148; <?php echo get_msg('mobile_setting_module'); ?>
							</a>
				        </div>
			      	</li>
			      	<li class="nav-item">
			      	...
			      	<li class="nav-item dropdown">
				        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
				        	&#10148;
				        	<?php echo get_msg('reports_group'); ?>
				        </a>
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				        	<a class="dropdown-item" href="<?php echo site_url('admin/popularcategories');?>"> 
					  					&#10148;<?php echo get_msg('popular_cat_view'); ?>
					  		</a>
				          	<div class="dropdown-divider"></div>
				          	<a class="dropdown-item" href="<?php echo site_url('/admin/purchasedcategories');?>"> 
								  		&#10148; <?php echo get_msg('purchased_cat_view'); ?>
							</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href='<?php echo site_url('/admin/deliboy_ratings');?>'>
                                    &#10148; <?php echo get_msg('deliboy_rating_log_module'); ?>
                            </a>

                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href='<?php echo site_url('/admin/all_deliboys');?>'>
                                    &#10148; <?php echo get_msg('deliboy_list_label'); ?>
                            </a>
				        </div>
			      	</li>
			    </ul>
