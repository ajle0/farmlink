    ...
    <div class="sidebar">
      ...
      <div class="text-center mt-3">
          <div class="image">
            ...
            ?>
          <img src="<?php echo isset($images[0]) ? img_url( $images[0]->img_path ) : base_url('assets/img/default-logo.png'); ?>" class="img-circle elevation-2" alt="User Image">
          </div>
          <?php if( $shop_id != ""): ?>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview" style="margin-left: 2px;">
            <a href="<?php echo site_url('admin/active_orders_dashboard/index/'. $shop_id);?>" class="nav-link">
             <i class="fa fa-bullhorn" style="padding-right: 7px;"></i>
              <p>
                <?php echo get_msg('active_orders_label'); ?>
              </p>
            </a>
          </li>
        ...
        <?php } else{ ?>
          ...
          <li class="nav-item has-treeview" style="margin-left: 2px;">
            <a href="<?php echo site_url('admin/active_orders_dashboard/index/'. $shop_id);?>" class="nav-link">
             <i class="fa fa-bell" style="padding-right: 7px;"></i>
              <p>
              <?php echo get_msg('active_orders_label'); ?>
              </p>
            </a>
          ...
          <li class="nav-item has-treeview" style="margin-left: 15px;">
             <a href="<?php echo site_url('/admin/shops') ?>">
              ...
              <?php echo get_msg('back_to_shop_list'); ?>
              </p>
            </a>
          </li>
        <?php } ?>
