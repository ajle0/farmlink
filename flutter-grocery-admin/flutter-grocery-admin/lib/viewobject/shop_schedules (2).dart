  ...
  ShopSchedules? fromMap(dynamic dynamicData) {
   if (dynamicData != null) {
      return ShopSchedules(
        isMondayOpen: dynamicData['is_monday_open']?.toString(),
        mondayOpenHour: dynamicData['monday_open_hour']?.toString(),
        mondayCloseHour: dynamicData['monday_close_hour']?.toString(),
        isTuesdayOpen: dynamicData['is_tuesday_open']?.toString(),
        tuesdayOpenHour: dynamicData['tuesday_open_hour']?.toString(),
        tuesdayCloseHour: dynamicData['tuesday_close_hour']?.toString(),
        isWednesdayOpen: dynamicData['is_wednesday_open']?.toString(),
        wednesdayOpenHour: dynamicData['wednesday_open_hour']?.toString(),
        wednesdayCloseHour: dynamicData['wednesday_close_hour']?.toString(),
        isThursdayOpen: dynamicData['is_thursday_open']?.toString(),
        thursdayOpenHour: dynamicData['thursday_open_hour']?.toString(),
        thursdayCloseHour: dynamicData['thursday_close_hour']?.toString(),
        isFridayOpen: dynamicData['is_friday_open']?.toString(),
        fridayOpenHour: dynamicData['friday_open_hour']?.toString(),
        fridayCloseHour: dynamicData['friday_close_hour']?.toString(),
        isSaturdayOpen: dynamicData['is_saturday_open']?.toString(),
        saturdayOpenHour: dynamicData['saturday_open_hour']?.toString(),
        saturdayCloseHour: dynamicData['saturday_close_hour']?.toString(),
        isSundayOpen: dynamicData['is_sunday_open']?.toString(),
        sundayOpenHour: dynamicData['sunday_open_hour']?.toString(),
        sundayCloseHour: dynamicData['sunday_close_hour']?.toString(),
      );
    } else {
      return null;
    }
