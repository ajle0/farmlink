...
class ScheduleHeader extends PsObject<ScheduleHeader> {
  ...
  @override
  bool operator ==(Object other) => other is ScheduleHeader && id == other.id;
  ...
  ScheduleHeader fromMap(dynamic dynamicData) {
    //if (dynamicData != null) {
      return ScheduleHeader(
          ...
          scheduleList: ScheduleDetail().fromMapList(dynamicData['schedule_detail']),
      );
    // } else {
    //   return null;
    // }
  ...
  Map<String, dynamic>? toMap(dynamic object) {
    if (object != null) {
      ...
      data['schedule_detail'] = ScheduleDetail().toMapList(object.scheduleList);
      return data;
    } else {
      return null;
    }
  ...
  List<ScheduleHeader> fromMapList(List<dynamic> dynamicDataList) {
    ...
    //if (dynamicDataList != null) {
      for (dynamic json in dynamicDataList) {
        if (json != null) {
          scheduleHeaderList.add(fromMap(json));
        }
      }
    //}
