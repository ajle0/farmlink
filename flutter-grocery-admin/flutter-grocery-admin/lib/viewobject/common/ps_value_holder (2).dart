...
class PsValueHolder {
  ...
  int? collectionProductLoadingLimit;
  int? discountProductLoadingLimit;
  int? featureProductLoadingLimit;
  int? latestProductLoadingLimit;
  int? trendingProductLoadingLimit;
  int? shopLoadingLimit;
