...
class ToUser extends PsObject<ToUser> {
  ToUser(
      {this.userId,
      this.userIsSysAdmin,
      this.isShopAdmin,
  ...
  @override
  bool operator ==(Object other) => other is ToUser && userId == other.userId;
  ...
  @override
  ToUser fromMap(dynamic dynamicData) {
    //if (dynamicData != null) {
      return ToUser(
  ...
  @override
  Map<String, dynamic>? toMap(ToUser? object) {
    if (object != null) {
  ...
  @override
  List<ToUser> fromMapList(List<dynamic> dynamicDataList) {
    final List<ToUser> subUserList = <ToUser>[];
  ...
  @override
  List<Map<String, dynamic>?> toMapList(List<ToUser> objectList) {
    final List<Map<String, dynamic>?> mapList = <Map<String, dynamic>?>[];
    //if (objectList != null) {
      for (ToUser? data in objectList) {
        if (data != null) {
