...
import 'package:fluttermultigrocery/ui/checkout/one_page_checkout/billing_to_view.dart';
import 'package:fluttermultigrocery/ui/checkout/one_page_checkout/delivery_location_view.dart';
import 'package:fluttermultigrocery/ui/checkout/one_page_checkout/one_one_checkout_container_view.dart';
import 'package:fluttermultigrocery/ui/checkout/one_page_checkout/order_time_view.dart';
import 'package:fluttermultigrocery/ui/checkout/one_page_checkout/payment_method.dart';
// import 'package:fluttermultigrocery/ui/checkout/pay_stack_view.dart';
import 'package:fluttermultigrocery/ui/checkout/schedule_checkout_status_view.dart';
import 'package:fluttermultigrocery/ui/checkout/whatsapp_checkout/whatsapp_checkout_container_view.dart';
...
import 'package:fluttermultigrocery/ui/contact/contact_us_container_view.dart';
...
import 'package:fluttermultigrocery/ui/introslider/intro_slider_view.dart';
...
import 'package:fluttermultigrocery/ui/map/nearest_shop_google_map_view.dart';
import 'package:fluttermultigrocery/ui/map/nearest_shop_map_view.dart';
...
import 'package:fluttermultigrocery/ui/schedule_order/list/schedule_order_list_view.dart';
import 'package:fluttermultigrocery/ui/search/home_item_search_container_view.dart';
import 'package:fluttermultigrocery/ui/search/search_item_view_all/search_item_view_all_container.dart';
import 'package:fluttermultigrocery/ui/search/search_shop_view_all/search_shop_view_all_container.dart';
import 'package:fluttermultigrocery/ui/search/search_sub_category_view_all/search_sub_category_view_all_container.dart';
import 'package:fluttermultigrocery/ui/search_category_view_all/search_category_view_all_container.dart';
import 'package:fluttermultigrocery/ui/search_history/search_histroy_list_view.dart';
import 'package:fluttermultigrocery/ui/search_item/search_item_list_view.dart';
...
import 'package:fluttermultigrocery/viewobject/holder/intent_holder/checkout_status_schedule_intent_holder.dart';
...
import 'package:fluttermultigrocery/viewobject/holder/whatsApp_checkout_intent_holder.dart';
...
import '../ui/schedule_transaction/detail/schedule_transaction_item_list_view.dart';
...
import 'package:fluttermultigrocery/db/best_choice_dao.dart';
import 'package:fluttermultigrocery/db/shop_info_dao.dart';
import 'package:fluttermultigrocery/db/product_collection_header_dao.dart' as header_dao;

Route<dynamic> generateRoute(RouteSettings settings) {
  Utils.psPrintDebug('Route Name ${settings.name}');
  switch (settings.name) {
    ...
    case RoutePaths.home:
      return MaterialPageRoute<dynamic>(
          ...
          builder: (BuildContext context) {
            final psApiService = PsApiService();
            final basketDao = BasketDao.instance;
            final shopDao = ShopDao.instance;
            final productDao = ProductDao.instance;
            final categoryDao = CategoryDao();
            final bestChoiceDao = BestChoiceDao.instance;
            final shopInfoDao = ShopInfoDao.instance;
            final productCollectionHeaderDao = header_dao.ProductCollectionDao.instance;
            // Provide dummy/default values for PsValueHolder for now
            final psValueHolder = PsValueHolder(
              ...
              shippingTaxValue: '',
              appInfoVersionNo: '',
              appInfoForceUpdate: false,
              appInfoForceUpdateTitle: '',
              ...
              fbKey: '',
              isShowAdmob: '',
              defaultLoadingLimit: 10,
              categoryLoadingLimit: 10,
              collectionProductLoadingLimit: 10,
              discountProductLoadingLimit: 10,
              featureProductLoadingLimit: 10,
              latestProductLoadingLimit: 10,
              trendingProductLoadingLimit: 10,
              shopLoadingLimit: 10,
              showFacebookLogin: '',
              showGoogleLogin: '',
              showPhoneLogin: '',
              ...
              publishKey: '',
              paystackKey: '',
              isToShowIntroSlider: false,
              isUserAlradyChoose: false,
              paystackEnabled: '',
              shippingId: '',
            ...
            return MultiProvider(
              providers: [
                ...
                Provider<ShopDao>.value(value: shopDao),
                Provider<ProductDao>.value(value: productDao),
                Provider<header_dao.ProductCollectionDao>.value(value: productCollectionHeaderDao),
                Provider<CategoryDao>.value(value: categoryDao),
                Provider<BestChoiceDao>.value(value: bestChoiceDao),
                Provider<PsValueHolder>.value(value: psValueHolder),
                Provider<ShopRepository>(create: (_) => ShopRepository(psApiService: psApiService, shopDao: shopDao)),
                Provider<ProductRepository>(create: (_) => ProductRepository(psApiService: psApiService, productDao: productDao)),
                Provider<ProductCollectionRepository>(create: (_) => ProductCollectionRepository(psApiService: psApiService, productCollectionDao: productCollectionHeaderDao)),
                Provider<BasketRepository>(create: (_) => BasketRepository(basketDao: basketDao)),
                Provider<ShopInfoRepository>(create: (_) => ShopInfoRepository(psApiService: psApiService, shopInfoDao: shopInfoDao)),
                Provider<CategoryRepository>(create: (_) => CategoryRepository(psApiService: psApiService, categoryDao: categoryDao)),
                Provider<BestChoiceRepository>(create: (_) => BestChoiceRepository(psApiService: psApiService, bestChoiceDao: bestChoiceDao)),
                Provider<ShopInfoDao>.value(value: shopInfoDao),
                Provider<header_dao.ProductCollectionDao>.value(value: productCollectionHeaderDao),
              ],
              child: DashboardView(),
            );
    ...
    case RoutePaths.singlehome:
      ...
      return MaterialPageRoute<dynamic>(
          settings: const RouteSettings(name: RoutePaths.singlehome),
          builder: (BuildContext context) {
    ...
    case RoutePaths.introSlider:
      final Object? args = settings.arguments;
      final IntroSliderIntentHolder introSliderIntentHolder =
          args as IntroSliderIntentHolder;
      return PageRouteBuilder<dynamic>(
          pageBuilder: (_, Animation<double> a1, Animation<double> a2) =>
              IntroSliderView(
                  settingSlider: introSliderIntentHolder.settingSlider,
                  psAppInfo: introSliderIntentHolder.psAppInfo));
    ...
    //             basketTotalPrice: payStackInterntHolder.basketTotalPrice,
    //           ));
