          ...
          builder: (BuildContext context, Widget? child) {
            return FadeTransition(
              ...
              child: Transform(
                ...
                child: GestureDetector(onTap: onTap  as void Function()?, child: child),
              ),
            );
          });
    } else {
                          ...
                          Flexible(
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text(
                                  '${Utils.getString(context, 'basket_list__price')}  ${basket.product!.currencySymbol} ${Utils.getPriceFormat(basket.basketPrice!, valueHolder)}',
                                ...
                                Text(
                                  '${Utils.getString(context, 'basket_list__sub_total')} ${basket.product!.currencySymbol} ${Utils.getPriceFormat(subTotalPrice.toString(), valueHolder)}',
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
