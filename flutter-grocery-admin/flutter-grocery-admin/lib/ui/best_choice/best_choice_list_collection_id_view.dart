...
class BestChoiceListByCollectionIdView extends StatefulWidget {
  const BestChoiceListByCollectionIdView(
      {super.key,
  ...
  State<StatefulWidget> createState() {
    return _BestChoiceListByCollectionIdView();
  }
}

class _BestChoiceListByCollectionIdView
    extends State<BestChoiceListByCollectionIdView>
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        _productCollectionProvider!
            .nextProductListByCollectionId(widget.bestChoice.id!);
      }
    });
                                            ...
                                            child: Stack(
                                              children: <Widget>[
                                                ClipRRect(
                                                  ...
                                                  child: Text(
                                                    widget.bestChoice.name!,
                                                    textAlign: TextAlign.start,
                                                    style: Theme.of(context).textTheme.titleLarge!.copyWith(
                                                        color: widget.titleTextColor, fontWeight: FontWeight.bold),
                                                  ),
                                                ),
                                              ]),
                                          ),
