...
class SearchItemViewAllContainer extends StatefulWidget {
  const SearchItemViewAllContainer({super.key, 
      ...
      child: Scaffold(
        ...
        body: ChangeNotifierProvider<SearchProductProvider>(
          ...
          create: (BuildContext content) {
            ...
            parameterHolder.searchTerm = widget.keyword;
            searchProductProvider.productParameterHolder = parameterHolder;
            searchProductProvider.loadProductListByKey(
          ...
          child: Consumer<SearchProductProvider>(builder: (BuildContext context,
            ...
            if (
              //searchProductProvider.productList != null &&
                searchProductProvider.productList.data != null 
               // searchProductProvider != null
                ) {
              return Column(
                children: <Widget>[
                  Expanded(
