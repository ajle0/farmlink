...
import 'package:fluttermultigrocery/provider/comment/comment_detail_provider.dart';
...
import 'package:fluttermultigrocery/viewobject/holder/comment_detail_holder.dart';
                      ...
                      if (commentController.text.isEmpty) {
                        ...
                        if (await Utils.checkInternetConnectivity()) {
                          Utils.navigateOnUserVerificationView(context,
                            ...
                            final PsResource<List<CommentDetail>> apiStatus =
