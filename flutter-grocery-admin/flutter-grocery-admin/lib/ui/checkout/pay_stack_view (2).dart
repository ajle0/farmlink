...
//           Utils.psPrintDebug('PayStack pickup ? $isClickPickUpButton');
//           Utils.psPrintDebug('PayStack total ? $basketTotalPrice');
...
//               isClickPickUpButton ? '0.0' : basketProvider.checkoutCalculationHelper.shippingCost.toString(),
//               isClickPickUpButton ? basketTotalPrice.toString(): basketProvider.checkoutCalculationHelper.totalPrice.toString(),
...
//                                           widget.isClickPickUpButton! ? widget.basketTotalPrice.toString() : widget
//                                               .basketProvider!
