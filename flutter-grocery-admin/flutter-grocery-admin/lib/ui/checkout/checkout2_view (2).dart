                              ...
                              if (apiStatus.data != null &&
                                ...
                                final BasketProvider basketProvider =
                                 ...
                                 if (shopInfoProvider!.shopInfo.data!
                                        .isArea == PsConst.ONE) {
                                          Utils.psPrintDebug('shopInfo.data.isArea == PsConst.ONE');
                                  basketProvider.checkoutCalculationHelper
                                      ...
                                      shopInfoProvider!.shopInfo.data!
                                        .deliFeeByDistance == PsConst.ONE) {
                                          Utils.psPrintDebug('shopInfo.data.deliFeeByDistance == PsConst.ONE');
                                  basketProvider.checkoutCalculationHelper
                                      .calculate(
                                      basketList: widget.basketList,
                                      couponDiscountString:
                                      ...
                                      shopInfoProvider!.shopInfo.data!
                                        .fixedDelivery == PsConst.ONE) {
                                          Utils.psPrintDebug('shopInfo.data.fixedDelivery == PsConst.ONE');
                                  basketProvider.checkoutCalculationHelper
                                      .calculate(
                                      basketList: widget.basketList,
                                      couponDiscountString:
                                      ...
                                      shopInfoProvider!.shopInfo.data!
                                        .freeDelivery == PsConst.ONE) {
                                          Utils.psPrintDebug('shopInfo.data.freeDelivery == PsConst.ONE');
                                  basketProvider.checkoutCalculationHelper
                                      .calculate(
                                      basketList: widget.basketList,
                                      couponDiscountString:
...
class _OrderSummaryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (shopInfoProvider.shopInfo.data!
          .isArea == PsConst.ONE) {
      Utils.psPrintDebug('shopInfo.data.isArea calcu == PsConst.ONE');
      basketProvider.checkoutCalculationHelper.calculate(
        ...
        shopInfoProvider.shopInfo.data!
          .deliFeeByDistance == PsConst.ONE) {
            Utils.psPrintDebug('shopInfo.data.deliFeeByDistance calcu == PsConst.ONE');
      basketProvider.checkoutCalculationHelper.calculate(
        basketList: basketList,
        couponDiscountString: couponDiscount,
        psValueHolder: psValueHolder,
        ...
        shopInfoProvider.shopInfo.data!
          .fixedDelivery == PsConst.ONE) {
       Utils.psPrintDebug('shopInfo.data.fixedDelivery calcu == PsConst.ONE');
      basketProvider.checkoutCalculationHelper.calculate(
        basketList: basketList,
        couponDiscountString: couponDiscount,
        psValueHolder: psValueHolder,
        ...
        shopInfoProvider.shopInfo.data!
          .freeDelivery == PsConst.ONE) {
       Utils.psPrintDebug('shopInfo.data.area and freedeli calcu == PsConst.ONE');
      basketProvider.checkoutCalculationHelper.calculate(
        basketList: basketList,
        couponDiscountString: couponDiscount,
        psValueHolder: psValueHolder,
        ...
        child: Column(
          ...
          children: <Widget>[
           ...
           if (provider.deliveryCost.data == null || 
                ...
                basketList[0].product!.shop!.isArea == PsConst.ONE)
            _OrderSummeryTextWidget(
              transationInfoText:
            ...
            // _OrderSummeryTextWidget(
            //   transationInfoText:
            //       '$currencySymbol  ${Utils.calculateShippingTax(userProvider.selectedArea.price == '' ? '0.0' : provider.deliveryCost.data.totalCost, psValueHolder.shippingTaxValue == '' ? '0.0' : psValueHolder.shippingTaxValue)}',
            //   title:
            //       '${Utils.getString(context, 'checkout__shipping_tax')} (${psValueHolder.shippingTaxLabel} %) :',
            // ),
