...
class __ImageWidgetState extends State<_ImageWidget> {
  ...
  Widget build(BuildContext context) {
    Future<void> pickImage() async {
      ...
      try {
        resultList = await MultiImagePicker.pickImages(
          ...
          actionBarColor: PsColors.black,
          actionBarTitle: 'All Photos',
          allViewTitle: 'All Photos',
          useDetailsView: false,
          selectCircleStrokeColor: PsColors.mainColor,
          ),
        );
      ...
      if (images.isNotEmpty) {
        if (images[0].name.contains('.webp')) {
          ...
          PsProgressDialog.dismissDialog();
          final PsResource<User> apiStatus = await widget.userProvider!
              .postImageUpload(
    ...
    final Widget editWidget = Container(
    ...
    final Widget imageInCenterWidget = Positioned(
        top: 110,
        child: Stack(
          children: <Widget>[
            SizedBox(
