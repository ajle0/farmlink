...
class _HeaderIconAndTextWidget extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final Widget textWidget = Text(Utils.getString(context, 'app_name'),
        style: Theme.of(context)
            .textTheme
            .titleLarge!
            .copyWith(color: PsColors.mainColor));
...
class _CardWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const EdgeInsets marginEdgeInsetsforCard = EdgeInsets.only(
    ...
    return Card(
      ...
      child: Column(
        children: <Widget>[
          Container(
            margin: marginEdgeInsetsforCard,
            child: TextField(
...
class __SendButtonWidgetState extends State<_SendButtonWidget> {
  Future<String> verifyPhone() async {
    ...
    verifySuccess(AuthCredential user) {
      print('verify');
      PsProgressDialog.dismissDialog();
    }
    verifyFail(FirebaseAuthException exception) {
