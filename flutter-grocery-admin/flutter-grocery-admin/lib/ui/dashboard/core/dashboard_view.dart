...
import 'package:fluttermultigrocery/ui/common/dialog/share_app_dialog.dart';
...
import 'package:fluttermultigrocery/ui/dashboard/home/main_dashboard_view.dart';
...
import '../../schedule_order/list/schedule_order_list_view.dart';
            ...
            ? BottomNavigationBar(
                ...
                items: <BottomNavigationBarItem>[
                  ...
                  BottomNavigationBarItem(
                    ...
                    label:
                        Utils.getString(context, 'home__drawer_menu_category'),
                  ),
                  BottomNavigationBarItem(
          ...
          child: Builder(
            builder: (BuildContext context) {
              ...
              if (_currentIndex ==
                ...
                return const ScheduleOrderListView(
                  isHideAppBar: true,
                );
              } else {
...
class _DrawerHeaderWidgetWithUserProfile extends StatefulWidget {
  const _DrawerHeaderWidgetWithUserProfile(
      {required this.provider, required this.deleteTaskProvider});
...
class __DrawerHeaderWidgetWithUserProfileState
    extends State<_DrawerHeaderWidgetWithUserProfile> {
  @override
  Widget build(BuildContext context) {
    return DrawerHeader(
      decoration: BoxDecoration(color: PsColors.mainColor),
        ...
        children: <Widget>[
          Container(
            ...
            child: PsNetworkCircleImageForUser(
              photoKey: '',
              imagePath: widget.provider.user.data!.userProfilePhoto,
              boxfit: BoxFit.cover,
            ),
          ),
          Column(
              ...
              children: <Widget>[
                Padding(
                    padding: const EdgeInsets.only(
                        left: PsDimens.space8, top: PsDimens.space14),
                    child: Text(
                ...
                if (widget.provider.user.data!.address != '')
                  Row(
                    children: <Widget>[
                      Padding(
                        padding: const EdgeInsets.only(
                            left: PsDimens.space6, top: PsDimens.space4),
                        child: Icon(
                          Icons.location_on,
