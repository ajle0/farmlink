...
import 'package:fluttermultigrocery/provider/category/search_category_provider.dart';
...
class SearchCategoryViewAll extends StatefulWidget {
  const SearchCategoryViewAll({super.key, required this.keyword});
    ...
    return WillPopScope(
        ...
        child: ChangeNotifierProvider<SearchCategoryProvider>(
            ...
            child: Consumer<SearchCategoryProvider>(builder:
              ...
              if (
                  searchCategoryProvider.categoryList.data != null) {
