              ...
              InkWell(
                ...
                onTap: () async {
                  if (await canLaunchUrl(Uri.parse('tel://${data.aboutPhone}'))) {
                    await canLaunchUrl(Uri.parse('tel://${data.aboutPhone}'));
                  } else {
                  ...
                  InkWell(
                    ...
                    onTap: () async {
                      if (await canLaunchUrl(Uri.parse('mailto:teamps.is.cool@gmail.com'))) {
                        await canLaunchUrl(Uri.parse('mailto:teamps.is.cool@gmail.com'));
                      } else {
                ...
                InkWell(
                  ...
                  onTap: () async {
                    if (await canLaunchUrl(Uri.parse('tel://${phone.aboutPhone}'))) {
                      await canLaunchUrl(Uri.parse('tel://${phone.aboutPhone}'));
                    } else {
                      throw 'Could not Call Phone Number 1';
                    }
                  },
...
class _TitleAndDescriptionWidget extends StatelessWidget {
  const _TitleAndDescriptionWidget({this.data});
