...
import 'package:fluttermultigrocery/ui/common/dialog/delivery_boy_rating_input_dialog.dart';
...
class _ColorCircleWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget verticalLineWidget = Container(
