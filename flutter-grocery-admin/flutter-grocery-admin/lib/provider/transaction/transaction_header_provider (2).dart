...
late  StreamController<PsResource<TransactionHeader>> transactionHeaderStream;
 ...
 late StreamController<PsResource<List<TransactionHeader>>> transactionListStream;
  ...
  Future<dynamic> postRefund(
    String transactionHeaderId,
  ) async {
    final TransactionHeaderMap newPost = TransactionHeaderMap(
    ...
    _transactionSubmit = await _repo!.postRefund(newPost.toMap(),
        isConnectedToInternet, PsStatus.PROGRESS_LOADING, transactionHeaderId);
