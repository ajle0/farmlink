...
class ShopRatingProvider extends PsProvider {
  ShopRatingProvider({
    required ShopRatingRepository? repo, 
 ...
 late StreamSubscription<PsResource<List<ShopRating>>> subscription;
late  StreamController<PsResource<List<ShopRating>>> shopRatingListStream;
