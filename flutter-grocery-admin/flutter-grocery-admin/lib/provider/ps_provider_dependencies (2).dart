...
import 'package:fluttermultigrocery/db/schedule_detail_dao.dart';
...
List<SingleChildWidget> _dependentProviders = <SingleChildWidget>[
  ...
  ProxyProvider2<PsApiService, SearchResultDao, SearchResultRepository>(
      update: (_, PsApiService apiService, SearchResultDao searchResultDao,
          ...
          SearchResultRepository(
              apiService: apiService, searchResultDao: searchResultDao)),
  ...
  ProxyProvider2<PsApiService, ScheduleDetailDao, ScheduleDetailRepository>(
      update: (_,
              ...
              ScheduleDetailRepository? scheduleHeaderRepository) =>
  ...
  ProxyProvider2<PsApiService, DeliveryBoyRatingDao,
    ...
    update: (_, PsApiService psApiService, DeliveryBoyRatingDao ratingDao,
        ...
        DeliveryBoyRatingRepository(
            psApiService: psApiService, ratingDao: ratingDao),
  ),
