...
class _CheckoutContainerViewState extends State<CheckoutContainerView> {
  ...
  double basketTotalPrice = 0.0;
  static dynamic checkout1ViewState;
  // static dynamic checkout2ViewState;
    ...
    if (viewNo == 1) {
      ...
      return Container(
        ...
        child: Checkout3View(
          ...
          checkout1ViewState.isWeeklyScheduleOrder,
        ),
      );
    }
  }
    ...
    return MultiProvider(
        ...
        child: Scaffold(
          ...
          bottomNavigationBar: checkHideOrShowBackArrowBar(
              closeCheckoutContainer, tokenProvider),
        ));
  }
  ...
  dynamic checkHideOrShowBackArrowBar(
      Function closeCheckoutContainer, TokenProvider? tokenProvider) {
    if (viewNo == 4) {
      return Container(
        height: 0,
      );
                      ...
                      children: <Widget>[
                        ...
                        Positioned(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () {
                              weekDays =
                                  checkout1ViewState.getSelectedDayAndTime()[0];
                              selectedTimes =
                                  checkout1ViewState.getSelectedDayAndTime()[1];
  ...
  dynamic clickToNextCheck(User user, Function closeCheckoutContainer,
    ...
    if (viewNo < maxViewNo) {
      if (viewNo == 3) {
        ...
        if (checkout3ViewState.isCheckBoxSelect) {
          ...
          //                           checkout3ViewState.memoController.text,
          //                       paystackKey:
          //                           shopInfoProvider!.shopInfo.data!.paystackKey,
          //                       publishKey: valueHolder!.publishKey,
          //                       isClickPickUpButton: checkout1ViewState
          //                           .userProvider.isClickPickUpButton,
          //                       deliveryPickUpDate:
                  ...
                  return ConfirmDialogView(
                      ...
                      onAgreeTap: () async {
                        ...
                        if (checkout1ViewState.isWeeklyScheduleOrder) {
                          returnData =
                              await checkout3ViewState.callScheduleCardNow(
                            basketProvider,
                            userProvider,
                          ...
                          returnData = await checkout3ViewState.callCardNow(
                            basketProvider,
                            userProvider,
                            transactionSubmitProvider,
                          );
        ...
        if (checkout1ViewState.userEmailController.text.isEmpty) {
        ...
        } else if (checkout1ViewState.userEmailController.text.isEmpty) {
          showDialog<dynamic>(
              context: context,
              builder: (BuildContext context) {
                return ErrorDialog(
          ...
          if (checkout1ViewState.isWeeklyScheduleOrder) {
            ...
            if (weekDays != '' && selectedTimes != '') {
              ...
              print(checkout1ViewState.userProvider.isClickDeliveryButton);
              print(checkout1ViewState.userProvider.isClickPickUpButton);
              if (!await checkout1ViewState.checkIsDataChange(userProvider)) {
                isApiSuccess = await checkout1ViewState
                    .callUpdateUserProfile(userProvider, provider);
          ...
          if (!await checkout1ViewState.checkIsDataChange(userProvider)) {
            isApiSuccess =
                await checkout1ViewState.callUpdateUserProfile(userProvider, provider);
            //chang checkout1 data
            if (isApiSuccess) {
              viewNo++;
            }
...
class _TopImageForCheckout extends StatelessWidget {
  const _TopImageForCheckout({this.viewNo, this.onTap});
