...
class __NotificationSettingWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    if (_psValueHolder!.isShowTokenId != null &&
        _psValueHolder!.isShowTokenId == PsConst.ONE) {
      isShowTokenId = true;
    } else {
      isShowTokenId = false;
    }
    final Widget switchButtonwidget = Switch(
        value: isSwitched,
    ...
    final Widget notiSettingTextWidget = Text(
      Utils.getString(context, 'noti_setting__onof'),
      style: Theme.of(context).textTheme.titleLarge,
    );

    final Widget messageTextWidget = Row(
      children: <Widget>[
        const Icon(
          FontAwesome5.bullhorn,
    ...
    return Column(
      children: <Widget>[
        ...
        if (isShowTokenId) _TokenIdWidget()
      ],
    );
  }
}
