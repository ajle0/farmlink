...
class HomeItemSearchView extends StatefulWidget {
  const HomeItemSearchView({super.key, 
...
class _ItemSearchViewState extends State<HomeItemSearchView> {
 ...
 late SearchProductProvider _searchProductProvider;
  ...
  Widget build(BuildContext context) {
    ...
    final Widget searchButtonWidget = PSButtonWidget(
        hasShadow: true,
    ...
    return SliverToBoxAdapter(
        child: ChangeNotifierProvider<SearchProductProvider>(
            ...
            create: (BuildContext content) {
              _searchProductProvider = SearchProductProvider(repo: repo1!, psValueHolder: psValueHolder);
              _searchProductProvider.productParameterHolder =
...
class __RatingRangeWidgetState extends State<_RatingRangeWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    dynamic firstRatingRangeSelected() {
    ...
    dynamic secondRatingRangeSelected() {
    ...
    dynamic thirdRatingRangeSelected() {
    ...
    dynamic fouthRatingRangeSelected() {
    ...
    dynamic fifthRatingRangeSelected() {
          ...
          children: <Widget>[
            Container(
              ...
              child: InkWell(
                ...
                child: firstRatingRangeSelected(),
              ),
            ),
            Container(
              ...
              child: InkWell(
                ...
                child: secondRatingRangeSelected(),
              ),
            ),
            Container(
              width: MediaQuery.of(context).size.width / 5.5,
              ...
              child: InkWell(
                ...
                child: thirdRatingRangeSelected(),
              ),
            ),
            Container(
              margin: const EdgeInsets.all(PsDimens.space4),
              ...
              child: InkWell(
                ...
                child: fouthRatingRangeSelected(),
              ),
            ),
            SizedBox(
              width: MediaQuery.of(context).size.width / 5.5,
              child: InkWell(
                ...
                child: fifthRatingRangeSelected(),
              ),
            ),
          ],
        ),
