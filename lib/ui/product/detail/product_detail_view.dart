...
class _ProductDetailState extends State<ProductDetailView>
  ...
  dynamic addAttributeFromRadioView(
    ...
    setState(() {
      ...
      basketSelectedAttribute.addAttribute(BasketSelectedAttribute(
          ...
          currencySymbol:
              productDetailProvider!.productDetail.data!.currencySymbol,
  ...
  Future<void> updateAddOnPrice(
    ...
    totalPrice = double.parse(
          productDetailProvider!.productDetail.data!.unitPrice!,
        ) +
        selectedAddOnPrice +
        selectedAttributePrice;
    totalOriginalPrice = double.parse(
          productDetailProvider!.productDetail.data!.originalPrice!,
        ) +
        selectedAddOnPrice +
        selectedAttributePrice;
              ...
              builder: (BuildContext context, ProductDetailProvider provider,
                ...
                if (
                  ...
                  if (isCallFirstTime) {
                    ...
                    /// Add to History
                    ///
                    provider.productDetail.data!.addedUserId = provider.psValueHolder!.loginUserId;
                                ...
                                _HeaderBoxWidget(
                                  ...
                                  originalPriceFormatString:
                                      Utils.getPriceFormat(provider
                                          .productDetail.data!.originalPrice!, psValueHolder!),
                                  unitPriceFormatString: Utils.getPriceFormat(
                                      provider.productDetail.data!.unitPrice!, psValueHolder!),
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                if (customizedDetail.additionalPrice == null ||
                  ...
                  Text(
                      '+ ${widget.productDetail.currencySymbol} ${Utils.getPriceFormat('${customizedDetail.additionalPrice}', psValueHolder!)}',
...
class _AddOnTileViewState extends State<AddOnTileView> {
  ...
  Widget build(BuildContext context) {
    ...
    if (
      //widget.holderBasketSelectedAddOnList != null &&
                                ...
                                children: <Widget>[
                                  ...
                                  if (widget.productDetail.addOnList![index]
                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                          '+ ${widget.productDetail.currencySymbol} ${Utils.getPriceFormat(
                                                  '${widget.productDetail.addOnList![index].price}', valueHolder)}'),
                                    ),
                                ]),
                          ),
                        );
                      ...
                      onTap: () async {
                        if (await Utils.checkInternetConnectivity()) {
                          Utils.navigateOnUserVerificationView(context,
                            ...
                            final PsResource<Product> apiStatus =
                    ...
                    child: (widget.productDetail.productDetail.data!
                        ...
                        ? Row(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                '${Utils.getString(context, 'product_detail__out_of_five_stars')}(${widget.productDetail.productDetail.data!
                                        .ratingDetail!.totalRatingCount!} ${Utils.getString(context, 'product_detail__reviews')})',
                                overflow: TextOverflow.ellipsis,
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyMedium!
...
class __HeaderPriceWidgetState extends State<_HeaderPriceWidget> {
  Future<bool> requestWritePermission() async {
    ...
    const Permission photos = Permission.photos;
    final PermissionStatus permissionss = await photos.request();
              ...
              children: <Widget>[
                ...
                PsHero(
                  ...
                  child: Material(
                      ...
                      child: Text(
                        widget.price != null
                            ? '${widget.product.currencySymbol} ${Utils.getPriceFormat(widget.price.toString(), valueHolder)}'
                            : '${widget.product.currencySymbol} ${Utils.getPriceFormat(widget.product.unitPrice!, valueHolder)}',
          ...
          if (widget.product.isDiscount == PsConst.ONE)
            Card(
              ...
              child: Container(
                ...
                child: Align(
                  child: Text(
                    '${widget.product.discountPercent}% ${Utils.getString(
...
class __AddToBasketAndBuyButtonWidgetState
  ...
  Widget build(BuildContext context) {
    ...
    void showDrawer(bool isBuyButtonType) {
                  ...
                  child: (widget.product.isDiscount == PsConst.ONE)
                      ? Row(
                          children: <Widget>[
                            ...
                            Text(
                              '${widget.product.currencySymbol} ${Utils.getPriceFormat(widget.product.originalPrice!, valueHolder)}',
                              overflow: TextOverflow.ellipsis,
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyMedium!
...
class _IconAndTextWidgetState extends State<_IconAndTextWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget addIconWidget = IconButton(
    ...
    final Widget removeIconWidget = IconButton(
        iconSize: PsDimens.space32,
...
class __FloatingActionButtonState extends State<_FloatingActionButton> {
  ...
  Widget build(BuildContext context) {
    final String whatsappUrl =
        'https://wa.me/${widget.product.shop!.whapsappNo}';
    final String messengerUrl = 'http://m.me/${widget.product.shop!.messenger}';
    final String phoneCall = 'tel://${widget.product.shop!.aboutPhone1}';
                      ...
                      if (await canLaunchUrl(Uri.parse(index == 0
                        ...
                        await launchUrl(Uri.parse(
                            index == 0
                                ? messengerUrl
                                : index == 1
                                    ? widget.product.shop!.whapsappNo  != '' 
                                        ? whatsappUrl 
                                        : phoneCall
                                    : phoneCall ,
                            // forceSafariVC: false
