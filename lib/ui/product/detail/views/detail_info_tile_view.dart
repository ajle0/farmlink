                ...
                if (nutrientList != null) {
                  return NutrientHorizontalListItem(
                    ...
                    onTap: () async {
                      ...
                      print('productParameterHolder.catId ${productParameterHolder.catId !}productParameterHolder.subCatId ${productParameterHolder.subCatId!}productParameterHolder.searchTerm ${productParameterHolder.searchTerm!}');
