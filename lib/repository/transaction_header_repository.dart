 ...
 late TransactionHeaderDao _transactionHeaderDao;
  ...
  Future<dynamic> getAllTransactionList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<TransactionHeader>> resource =
      ...
      if (resource.status == PsStatus.SUCCESS) {
        ...
        await _transactionHeaderDao.insertAll(primaryKey, resource.data!);
      } else {
  ...
  Future<PsResource<TransactionHeader>> postTransactionSubmit(
    ...
    final PsResource<TransactionHeader> resource =
