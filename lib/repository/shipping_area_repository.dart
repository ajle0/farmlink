...
late  PsApiService _psApiService;
 late ShippingAreaDao _shippingAreaDao;
  ...
  Future<dynamic> getAllShippingAreaList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<ShippingArea>> resource =
      ...
      if (resource.status == PsStatus.SUCCESS) {
        ...
        await _shippingAreaDao.insertAll(primaryKey, resource.data!);
      } else {
        if (resource.errorCode == PsConst.ERROR_CODE_10001) {
          await _shippingAreaDao.deleteAll();
        }
