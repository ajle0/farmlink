...
class LanguageRepository extends PsRepository {
  ...
  void loadLanguageValueHolder() {
    final String? languageCodeKey = _psSharedPreferences.shared
        .getString(PsConst.LANGUAGE__LANGUAGE_CODE_KEY);
    final String? countryCodeKey = _psSharedPreferences.shared
        .getString(PsConst.LANGUAGE__COUNTRY_CODE_KEY);
    final String? languageNameKey = _psSharedPreferences.shared
  ...
  Future<void> saveApiDefaultLanguage(Language language) async {
    await _psSharedPreferences.shared.setString(
        PsConst.LANGUAGE__API_DEFAULT_LANGUAGE_CODE_KEY,
        language.languageCode!);
    await _psSharedPreferences.shared.setString(
        PsConst.LANGUAGE__API_DEFAULT_COUNTRY_CODE_KEY, language.countryCode!);
    await _psSharedPreferences.shared.setString(
        PsConst.LANGUAGE__API_DEFAULT_LANGUAGE_NAME_KEY, language.name ?? '');
  ...
  Language getApiDefaultLanguage() {
    final String? languageCode = _psSharedPreferences.shared
            .getString(PsConst.LANGUAGE__API_DEFAULT_LANGUAGE_CODE_KEY) ??
        PsConfig.defaultLanguage.languageCode;
    final String? countryCode = _psSharedPreferences.shared
            .getString(PsConst.LANGUAGE__API_DEFAULT_COUNTRY_CODE_KEY) ??
        PsConfig.defaultLanguage.countryCode;
    final String? languageName = _psSharedPreferences.shared
            .getString(PsConst.LANGUAGE__API_DEFAULT_LANGUAGE_NAME_KEY) ??
        PsConfig.defaultLanguage.name;
