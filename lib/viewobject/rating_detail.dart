...
class RatingDetail extends PsObject<RatingDetail?> {
  ...
  RatingDetail? fromMap(dynamic dynamicData) {
   if (dynamicData != null) {
      return RatingDetail(
          fiveStarCount: dynamicData['five_star_count']?.toString(),
          fiveStarPercent: dynamicData['five_star_percent']?.toString(),
          fourStarCount: dynamicData['four_star_count']?.toString(),
          fourStarPercent: dynamicData['four_star_percent']?.toString(),
          threeStarCount: dynamicData['three_star_count']?.toString(),
          threeStarPercent: dynamicData['three_star_percent']?.toString(),
          twoStarCount: dynamicData['two_star_count']?.toString(),
          twoStarPercent: dynamicData['two_star_percent']?.toString(),
          oneStarCount: dynamicData['one_star_count']?.toString(),
          oneStarPercent: dynamicData['one_star_percent']?.toString(),
          totalRatingCount: dynamicData['total_rating_count']?.toString(),
          totalRatingValue: dynamicData['total_rating_value']?.toString());
    } else {
      return null;
    }
  }
