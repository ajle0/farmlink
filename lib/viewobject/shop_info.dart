...
class ShopInfo extends PsObject<ShopInfo> {
  ...
  //  if (dynamicData != null) {
      return ShopInfo(
          ...
          added: dynamicData['added']?.toString(),
          ...
          isFeature: dynamicData['is_feature']?.toString(),
          ...
          minimumOrderAmount: dynamicData['minimum_order_amount']?.toString(),
          ...
          paystackEnabled: dynamicData['paystack_enabled']?.toString(),
          ...
          flutterWaveEnabled: dynamicData['flutter_wave_enabled']?.toString(),
          checkoutWithEmail: dynamicData['checkout_with_email']?.toString(),
          onePageCheckout: dynamicData['one_page_checkout']?.toString(),
          multiPageCheckout: dynamicData['multi_page_checkout']?.toString(),
          checkoutWithWhatsApp: dynamicData['checkout_with_whatsapp']?.toString(),
